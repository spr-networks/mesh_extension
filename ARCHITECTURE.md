...
The setParentCredentials call has a ParentCA field which includes /cert from the 
...
- the main SPR router then calls /parent_ert to place the SPR parent CA onto the mesh
